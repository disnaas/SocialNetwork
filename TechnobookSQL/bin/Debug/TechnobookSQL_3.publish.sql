...
CREATE TABLE [dbo].[Amis] (
    ...
    CONSTRAINT [PK_UsersID_AMIS] PRIMARY KEY CLUSTERED ([UsersID] ASC)
);
...
CREATE TABLE [dbo].[Utilisateurs] (
    ...
    [Pays]            NVARCHAR (18)  NOT NULL,
    [Rue]             NVARCHAR (75)  NOT NULL,
    [NumeroMaison]    INT            NOT NULL,
    [CodePostale]     NVARCHAR (6)   NOT NULL,
...
AS
	INSERT INTO Utilisateurs(Nom,Prenom,Pays,Rue,NumeroMaison,CodePostale,AdresseMail,Password,DateInscription,DateNaissance) VALUES (@Nom,@Prenom,@AdresseMail,HASHBYTES('SHA2_512',@Password),@DateInscription,@DateNaissance)
GO
