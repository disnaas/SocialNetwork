...
GO
ALTER TABLE [dbo].[Fil]
    ADD DEFAULT CONVERT (datetime, GETDATE()) FOR [DateLigne];
...
GO
PRINT N'Création de [dbo].[SP_AddFil]...';
...
AS
	...
	INSERT INTO Fil(UsersID,FilID,Text,DateLigne) VALUES (@UsersID,@FilID,@Text,@DateLigne)
GO
PRINT N'Création de [dbo].[SP_CheckUser]...';
