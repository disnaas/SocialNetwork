...
AS
	INSERT INTO Utilisateurs(Nom,Prenom,AdresseMail,Password,DateInscription,DateNaissance) VALUES (@Nom,@Prenom,@AdresseMail,HASHBYTES('SHA2_512',@Password),@DateInscription,@DateNaissance)
GO
